    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="pt-32 pb-16">
        <div className="container mx-auto px-6">
          {/* Header with white mode styling */}
          <div className="mb-12">
          ...
          {/* Graphics Grid with white mode styling */}
          {hasRealContent ? (
            ...
            <div className="flex items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <p className="text-white/50 white-mode:text-gray-500">PNL graphics will be showcased here</p>
                {isDegenMode && (
      ...
      {/* Edit Graphic Dialog - Upload only */}
      <Dialog open={editingCard !== null} onOpenChange={() => cancelEdit()}>
        <DialogContent className="bg-background white-mode:bg-white border-white/10 white-mode:border-gray-200 max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-white white-mode:text-gray-800">Edit PNL Graphic</DialogTitle>
          </DialogHeader>
          <div className="space-y-6">
            {/* Image Upload Section */}
            <div>
              <label className="text-white/80 white-mode:text-gray-700 text-sm mb-3 block font-medium">Graphic Image</label>
            ...
            {/* Title and other inputs with white mode styling */}
            <div>
